...
return [
    ...
    'accepted_if'          => 'The :attribute must be accepted when :other is :value. [HU]',
    ...
    'current_password'     => 'The password is incorrect. [HU]',
    ...
    'prohibits'            => 'The :attribute field prohibits :other from being present. [HU]',
    ...
    'custom'               => [
        'email' => [
            'not_regex' => 'A(z) :attribute nem tartalmazhat "+" jelet',
        ],
    ],
